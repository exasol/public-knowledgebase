...
Google Bigquery is able to connected with Exasol via the [Simba JDBC Driver](https://docs.cloud.google.com/bigquery/docs/reference/odbc-jdbc-drivers). This article will go through how you can import and export data with Google Bigquery.  
...
* Download the [Bigquery JDBC Driver](https://docs.cloud.google.com/bigquery/docs/reference/odbc-jdbc-drivers#current_jdbc_driver)
...
* [Bigquery Simba Driver](https://docs.cloud.google.com/bigquery/docs/reference/odbc-jdbc-drivers)
* [Introduction to loading data into Bigquery](https://cloud.google.com/bigquery/docs/loading-data)
