...
2. Select the DSN that your client or tool is using to connect to the database and click "Configure".![](images/Screenshot)
3. Click on the "Advanced" tab at the top:![](images/Screenshot)
