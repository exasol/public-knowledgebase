...
You have to contact Exasol support to receive the JDBC logs. For this we need the destination and filename of the logfile. If you are running Exasol version 8 or newer, then you can get into DB container yourself and pickup the file.
