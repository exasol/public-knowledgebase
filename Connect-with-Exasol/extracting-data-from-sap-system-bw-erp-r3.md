...
Link to product home page: [SAP-Integration mit Exasol](https://theobald-software.com/de/exasolution-destination.html):
...
>
> The central server component constitutes the data hub between SAP and Exasoln applications. Extractions are created as well as accesses released and monitored for consumers via the Designer. Access is to one or more SAP ERP or SAP BW systems.
>
...
![Theobald connector](images/Theobald.png)

## References

* [SAP-Integration mit Exasol](https://theobald-software.com/de/exasolution-destination.html)
