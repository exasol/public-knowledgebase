...
![ODBC Data sources](images/exaPieterjan_0-1622811291892.png)

Let's create a New Data Source.

![Create New Data Source](images/exaPieterjan_2-1622812662405.png)
...
![Exasol ODBC configuration](images/exaPieterjan_3-1622813651241.png)
...
![Provide credentials](images/exaPieterjan_7-1622814538607.png)

After clicking connect a navigator will pop up:

![Navigator](images/exaPieterjan_8-1622814763851.png)

Here you can select the data you'd like to import.

As an example I will pick a table with Chicago taxi companies:

![CHICAGO_TAXI schema](images/exaPieterjan_9-1622814828891.png)

You'll get a new sheet added to your excel file that contains the data you selected.

![COMPANIES table content](images/exaPieterjan_0-1622815383282.png)
...
![Query -> Edit](images/exaPieterjan_1-1622815699876.png)

or double click on the 'Queries and Connections' panel on the right.

![Queries and Connections](images/exaPieterjan_2-1622815772409.png)
...
![Data -> Get Data -> Launch Power Query Editor](images/exaPieterjan_2-1622817020741.png)

Right mouse click, select "New Query," "Other Sources," and then "Blank Query" respectively.

![New Query -> Other Sources -> Blank Query](images/exaPieterjan_1-1622816836526.png)
...
![PowerQuery editor](images/exaPieterjan_1-1622819067265.png)

Press 'Done'.

Excel will ask you for permission to run the native database query. Click on 'Edit Permission'.

![Edit Permission](images/exaPieterjan_2-1622819127011.png)

Select 'Run'.

![Native Database Query -> Run](images/exaPieterjan_3-1622819139266.png)

The results will pop up in the Power Query Editor.

Press 'Close and Load.'

![Close and Load](images/exaPieterjan_4-1622819164227.png)

The results should swiftly load in to your worksheet:

![Query Results](images/exaPieterjan_5-1622819225033.png)
