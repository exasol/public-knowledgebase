...
OAuthPvtKeyPath=/exa/data/bucketfs/<bucketfs-service>/<bucket-name>/<your-account-keyfile>;
EnableSession=1;
```
...
* [Simba Google BigQuery JDBC release-notes_1.3.0.1001.txt](https://storage.googleapis.com/simba-bq-release/jdbc/release-notes_1.3.0.1001.txt)
