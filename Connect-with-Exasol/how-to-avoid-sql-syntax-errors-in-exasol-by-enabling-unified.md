...
**You should generally avoid using so-called "identifiers" ([SQL reserved words](https://docs.exasol.com/db/latest/sql_references/system_tables/metadata/exa_sql_keywords.htm))** **as column names (e.g. DATE, TIMESTAMP, UPDATE, BEGIN, END, CHECK, TRUE, FALSE, etc.)** when creating your tables/views or setting aliases in SQL queries.
...
"\[EXASOL\]\[EXASolution driver\]syntax error, **unexpected DATE\_**, expecting UNION_ or EXCEPT_ or MINUS_ or INTERSECT_"
...
Unifying the quoting behaviour is available since the release of MicroStrategy 2020 and described in the following MicroStrategy Knowledge Base article: ****
...
**Download the latest Exasol JDBC driver** (or ODBC driver) from the Exasol Download section [Clients and Drivers](https://downloads.exasol.com/clients-and-drivers).
...
* [SQL reserved words](https://docs.exasol.com/db/latest/sql_references/system_tables/metadata/exa_sql_keywords.htm)
* [KB483540: Unified Quoting Behavior for Warehouse Identifiers in MicroStrategy 2021](https://community.microstrategy.com/s/article/KB483540-Unified-Quoting-Behavior-for-Warehouse-Identifiers?language=en_US)
* [Exasol 6.x](https://community.microstrategy.com/s/article/Exasol-6-x?language=en_US)
* [KB43537: How to install or upgrade DBMS objects provided by MicroStrategy Technical Support in MicroStrategy 2021](https://community.microstrategy.com/s/article/KB43537-How-to-install-DBMS-objects-provided-by-MicroStrategy?language=en_US)
* [Clients and Drivers](https://downloads.exasol.com/clients-and-drivers)
