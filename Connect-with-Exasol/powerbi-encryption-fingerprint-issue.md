...
The first thing you'll need to do is update the ODBC-drivers to the latest version by uninstalling the older ODBC drivers and then reinstalling the newer ones.
