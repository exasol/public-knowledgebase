# Training Badge - Exasol Certified Expert for Azure deployment

You may download and use the badge on this page according to the terms listed below if you passed the current online exam **Exasol Certified Expert for Azure deployment**.

![Expert Azure Badge](images/EXPERT_AZURE.png)
