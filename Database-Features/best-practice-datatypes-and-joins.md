...
As columns used to join tables often have the same name in different tables, one can verify if all columns with the same name have identical data types:
