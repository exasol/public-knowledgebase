...
Below is an overview of the system tables accessible for metadata and, where available, historical information.
...
FROM 
 EXA_DB_SIZE_DAILY
WHERE INTERVAL_START BETWEEN timestamp'2025-06-01 00:00:00' AND timestamp'2025-11-01 00:00:00';
```
...
FROM
 EXA_DB_SIZE_DAILY
WHERE
 INTERVAL_START BETWEEN timestamp'2025-06-01 00:00:00' AND timestamp'2025-11-01 00:00:00'
GROUP BY
