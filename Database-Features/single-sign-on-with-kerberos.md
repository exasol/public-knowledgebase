...
[Kerberos Single Sign-On](https://docs.exasol.com/db/7.1/administration/on-premise/access_management/kerberos_sso.htm)
...
| --- | --- |
| KERBEROSSERVICENAME | Service name part of the Kerberos principal.<br />Default: exasol |
| KERBEROSHOSTNAME | Hostname of the Kerberos principal.<br />Default: use hostname from the connection string |
