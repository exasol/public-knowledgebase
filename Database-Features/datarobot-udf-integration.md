...
```python
CREATE OR REPLACE PYTHON3 SCALAR SCRIPT "UDF_DataRobot" (deployment_id VARCHAR(100), explanations DECIMAL(2,0), json VARCHAR(5000)) EMITS ("PredictionJSON" VARCHAR(5000)) AS
#####################################################################
